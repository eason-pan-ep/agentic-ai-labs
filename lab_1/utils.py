...
def get_response(model: str = DEFAULT_GEMINI_MODEL, prompt: str = "") -> str:
...
def image_llm_call(model_name: str = DEFAULT_GEMINI_MODEL, prompt: str = "", media_type: str = "", b64: str = "") -> str:
    # Check if it's a Gemini model
    if model_name.startswith("gemini"):
        ...
        # Use Gemini vision model with client.models.generate_content
        response = gemini_client.models.generate_content(
            model=model_name,
