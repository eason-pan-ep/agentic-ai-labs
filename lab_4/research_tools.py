...
def arxiv_search_tool(query: str, max_results: int) -> list[dict]:
    """
    Searches arXiv for research papers matching the given query.
    suggested max_results = 5.
    """
...
arxiv_tool_def = {
    ...
    "function": {
        ...
        "description": "Searches for research papers on arXiv by query string. suggested max_results = 5.",
        "parameters": {
            "type": "object",
            "properties": {
                "query": {
...
def tavily_search_tool(query: str, max_results: int, include_images: bool) -> list[dict]:
    """
    Perform a search using the Tavily API.

    Args:
        query (str): The search query.
        max_results (int): Number of results to return (suggest 5).
...
def wikipedia_search_tool(query: str, sentences: int) -> list[dict]:
    """
